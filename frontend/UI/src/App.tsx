            ...
            >
              ...
              <button title="Notifications" className="text-slate-600 hover:text-[#083344] transition-colors p-1 shrink-0">
                ...
                <button
                  type="button"
                  onClick={openMapView}
                  className="ml-1 px-6 py-1.5 bg-white/80 border border-[#bae6fd] text-[#0284c7] font-bold rounded-full hover:bg-[#0284c7] hover:text-white transition-all duration-300 shadow-sm hover:shadow-md whitespace-nowrap shrink-0"
                >
                View Map
              </button>
            </motion.nav>
